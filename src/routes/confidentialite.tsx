    ...
    <main className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-3xl px-5 py-14 sm:py-20">
        ...
        <div className="mt-10 space-y-8 leading-relaxed text-muted-foreground">
          ...
          <section><h2 className="text-xl text-foreground">Destinataire et hébergement</h2><p className="mt-3">VISAVIE Fermeture est l'unique destinataire de vos données. Elles sont hébergées par Lovable Cloud.</p></section>
